...
public class CheckDuplicates {
    ...
    private static Set<Integer> createSet(String filename) {
        ...
        try (FileInputStream setFile = new FileInputStream(filename)) {
            ...
            // set = new UnorderedIntSet<Integer>(numToRead);
            // set = new UnorderedIntSet<Integer>(numToRead);
            set = new OrderedSet<Integer>(numToRead);
    ...
    // by the integers themselves.
    private static void check(Set<Integer> set, String filename) {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> set = createSet(args[0]);
